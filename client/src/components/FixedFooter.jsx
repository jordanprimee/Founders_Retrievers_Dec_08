  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={`w-[12rem] sm:w-[12rem] md:w-[12rem]  lg:w-[30rem] h-[4rem] bg-[#4E4E4E] rounded-[0.55rem] flex flex-row gap-2 p-1.5 justify-end`}
        >
          <div
          ...
          <div
            className={`${
              isClicked ? "hidden" : "lg:hidden   md:flex  sm:flex bg-[#3E3E3E] text-[#fff]  border border-[#ffffff50] p-4  w-[3rem] h-[3rem] rounded-[0.55rem]  flex-row justify-center items-center"
            }`}
          >
            {" "}
          ...
          <div
            className={`${
              isClicked ? "hidden" : "hidden sm:hidden md:scale-60 lg:flex"
            } 
             w-[24rem] bg-[#3E3E3E] rounded-[0.55rem] pl-4  flex-row gap-2 p-1 justify-end	`}
          >
            <Link
              to="/"
