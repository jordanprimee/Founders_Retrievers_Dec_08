    ...
    <>
      ...
      >
        ...
        <div className="text-[1rem] font-light text-[#fff] text-wrap text-center">
          {" "}
          Kindly note that when your item is found; our delivery firm will contact you
          to get your lost belonging back and you will pay 5 JD fee to get recieve it.{" "}
