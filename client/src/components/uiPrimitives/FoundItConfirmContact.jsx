...
import Payment from "../PaymentTwo/Payment";
import { FoundItDeliveryAlert } from "./FoundItDeliveryAlert";
Modal.setAppElement(document.getElementById("root"));

export const FoundItConfirmContact = ({ isOpen, onRequestClose }) => {
  ...
  const modalStyle = {
    overlay: {
      ...
      zIndex: 50, // Set the z-index for the overlay
    },
  };
  return (
    <>
     {deliveryAlertIsOpen && (
        <FoundItDeliveryAlert
          isOpen={openPayment}
