...
export const FailedToAddUser= ({ isOpen, onRequestClose }) => {
  const modalStyle = {
    overlay: {
  ...
  return (
    <>
      <Modal
        className="flex flex-col align-center justify-center gap-8 p-8 bg-[#373737] rounded-[1rem] w-[34rem] h-[18rem] absolute  bottom-1/2 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 lg:scale-100 sm:scale-75 md:scale-75 scale-[0.45]"
        isOpen={isOpen}
        style={modalStyle}
      ...
      >
        ...
        <div className="flex flex-col text-[1rem] mb-12 font-light text-[#fff] text-wrap text-center">
