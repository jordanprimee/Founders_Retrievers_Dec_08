  ...
  const fetchPartnersData = async () => {
    try {
      ...
      const calculatedTotalPages = Math.ceil(
        partnersResponse.data.total / partnersResponse.data.limit
      );
    ...
    axios
      ...
      .then(() => {
        ...
        setPartnersData((prevPartnersData) =>
          prevPartnersData.filter(
            (partners) => partners.partners_id !== partners_id
          )
        );
      })
      .catch((error) => {
      ...
      <div className="mx-8">
        ...
        <div className="flex flex-row justify-between mb-4 w-auto sm:mx-0.5 lg:mx-0.5 ">
          <form
            ...
            class="pt-2 relative self-end	mr-8"
          >
            <input
                      ...
                      partnersData.map((item, index) => (
                        ...
                        >
                          ...
                          <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                            <button
                              onClick={(e) =>
                                handleDeletePartners(item.partners_id)
                              }
