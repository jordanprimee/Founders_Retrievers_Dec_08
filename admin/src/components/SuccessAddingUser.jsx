...
import { Cancel, Happy } from "../assets/IconsSVGConst";
Modal.setAppElement(document.getElementById("root"));

export const SuccessAddingUser = ({ isOpen, onRequestClose }) => {
  const modalStyle = {
    overlay: {
  ...
  return (
    <>
      ...
      >
        ...
        {/* <button
          type="submit"
          className="self-center px-3 pb-2 text-[#fff] bg-transparent border border-1 border-[#fff] font-light focus:outline-none hover:bg-[#ffffff] hover:text-[#373737] text-xs  rounded-lg text-md px-5 py-2 mt-8 mb-8 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700"
        >
